...
public class PlayerMoovement : MonoBehaviour {
    ...
    private ContactFilter2D moovementContactFilter;
    ...
    void Start() {
        moovementContactFilter = BuildContactFilter2DForLayer(LayerMask.LayerToName(gameObject.layer));
    ...
    private void Movement(Vector2 move)
    {
        ...
        {
            int movementCollisionHitCount = playerRigidbody2D.Cast(move, moovementContactFilter, hitBuffer,distance + shellRadius);
